...
export default class SearchForm extends React.Component {
  ...
  formatDate(date) {
    ...
    // If any third party library like moment.js is used, I would prefer working on Date objects
      ...
      <div className="search-container">
        <div className="search-form">
          ...
          <form className="form-search" onSubmit={this.searchBeer}>
            <input id="search_input" className="search-input" placeholder='eg: lager'
            ...
            <div className="search-radio-group">
              ...
              <span>
                <input type="radio" id="brew" name="search" 
